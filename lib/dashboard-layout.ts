...
export const dashboardMainClassName =
  "flex-1 w-full min-w-0 px-5 py-6 md:px-8 md:py-8 lg:px-10 lg:py-9 xl:px-12 xl:py-10 2xl:px-16 bg-gradient-to-b from-muted/40 via-background to-background"
