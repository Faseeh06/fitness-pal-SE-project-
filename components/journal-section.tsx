...
const entries = [
  {
    date: "Tips",
    title: "Hydration: spacing glasses through the day beats chugging late",
    tag: "Hydration",
  },
  {
    date: "Training",
    title: "Strength blocks: track sets and rest — duration feeds calorie estimates",
    tag: "Workout",
  },
  {
    date: "Nutrition",
    title: "Meal typing: label breakfast, lunch, dinner, snack for clearer daily totals",
    tag: "Nutrition",
  },
  {
    date: "Roadmap",
    title: "Charts next: weight, steps, and calories over time on the Progress screen",
    tag: "Progress",
  },
]
